...
const Footersec = () => {
  return (
    <div className="bg2-blue pt-lg-5" id="join">
      <section className="bg-footer py-lg-5 ">
        <div className=" pb-5">
          <div className="container">
            <div className="d-flex justify-content-center align-items-center pt-5">
              <h2 className="ff-poppins text-white fs-50 lh-124 fw-semibold ">
                JOIN US
              </h2>
            </div>
            <div className="row align-items-center pt-md-5">
              <div className="col-md-6 col-12 pt-md-5 d-flex justify-content-md-start justify-content-center flex-column align-items-md-start align-align-items-center">
                <p className="pt-md-5 pt-3 fs-30 fw-medium lh-124 ff-poppins text-white">
                  LOGO
                </p>
                <p className="pt-3 fs-16 fw-normal text-white opacity-70 lh-150 max-w-332">
                ...
                <p className="pt-3">
                  <a
                    href=""
                    className="fs-16 fw-normal ff-poppins text-white lh-150 text-decoration-none"
                  >
                    Email@gmail.com
                  </a>
                </p>
              </div>
              <div className="col-md-6 pt-md-5 col-12 pt-md-5 pt-4 d-flex justify-content-md-center justify-content-start">
                <div className="row">
                  <div className="col-6">
                    <ul>
                      <li className="fs-16 fw-medium lh-150 text-white ff-poppins text-decoration-none">
                        Resources
                      </li>
                      <li className="pt-2">
                        <a
                          href=""
                          className="text-white fs-14 nav-line position-relative text-decoration-none text-nowrap ff-poppins fw-normal lh-136"
                        >
                          Roadmap
                        </a>
                      </li>
                  ...
                  <div className="col-6 d-flex justify-content-end">
                    <ul>
                      ...
                      <ul className="d-flex align-items-center gap-3 pt-3">
                        <li>
