...
const Section2 = () => {
  return (
    <div>
      <section className="bg2-blue pb-md-5 pb-2 overflow-x-clip position-relative z-1" id="mining">
        <div className="container">
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-6 col-12 position-relative">
              <img
                className="w-100 h-100"
                src="https://s3-alpha-sig.figma.com/img/c31c/97e5/a8782abe03efd9be473dcc83fb5060f8?Expires=1702857600&amp;Signature=i--2hFNVH8yEsqhtkpKk7fz1Oo6giXrfT-AYqr3rj~ANLSE-H9mCIqD6uqlQPOdtoEgD3K7YaBFQcqurAJiw2mQDxgSkBHhYgjN76OcgOJp8TXrdt9C-H435JCko5avpw4rt4zwVvAv~0U1pqJ4mgRhcKX-5yQC3O4PfWLmOehUUHLA4bxsa4ajiRXG23SPozbtKXrblWnvAlROsukTP~8fHinBOHhSnMbLnUKvs9yllODx0yhxCU5CCkWpsXJi~Sjz5tv4ZZ8Nk46-ddX10Gp4gaa7C8rCMo4CC56f5iFPlxklDHVHMu4Ld47u7MOfPtEU~2xxwazUyQ~b0JhMmQQ__&amp;Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4"
                width="486"
                height="486"
              />
              <div className="ellipse1"></div>
            </div>
            <div className="col-lg-6 col-12 d-flex flex-column justify-content-end align-items-center  pt-lg-5 mt-5">
              <div>
                <h2 className="ff-poppins fs-50 fw-medium text-white lh-136">
                  Mint Your Bat
                </h2>
                <p className="pt-lg-5 pt-md-3 pt-2 ff-poppins fw-medium lh-136 fs-30 text-white mb-0">
                  Minting: 1,5 SOL
                </p>
                <p className="ff-poppins text-white fs-16 lh-136 fw-normal text-decoration-line-through opacity-70">
                  Before 2 SOL
                </p>
                <p className="pt-3 ff-poppins fw-medium lh-136 fs-30 text-white mb-0">
                  Whitelist: 0,88 SOL
                </p>
                <p className="ff-poppins text-white fs-16 lh-136 fw-normal text-decoration-line-through opacity-70">
                  Before 1 SOL
                ...
                <div className="pt-3">
                  <button className="text-blue mt-lg-5 mt-2 ff-poppins fs-16 fw-medium lh-nor combtn">
                    Coming soon
                  </button>
                </div>
                <ul className="d-flex align-items-center gap-3 pt-lg-5 pt-3">
                  <li>
